...
public enum LifeHeroArt {
    ...
    public static let appearances:[String:Appearance] = {
        let rows:[(String,String,String,Int,Int,Double)] = [
            ...
            ("dianwei","#6B5547","#D2A979",2,2,1.31),
            ("huanggai","#8A7658","#DAC697",3,4,1.12),
            ("taishici","#4E7B83","#D3C28E",3,0,1.09),
            ("sunce","#986746","#E0B875",3,0,1.13),
            ("sunshangxiang","#AD785B","#E0C5A1",4,0,0.99),
            ("zhoutai","#556F5D","#BEA77B",2,2,1.19),
            ("chengpu","#7A6953","#D3BD92",3,3,1.1),
            ("jiangwan","#697D72","#D8C7A2",0,1,1.02),
            ("feiyi","#98A284","#5F7771",5,0,0.94),
            ("wangping","#677B8D","#D0B791",2,1,1.08),
            ("dingfeng","#8A594B","#D2BD95",2,2,1.07),
            ("handang","#8C885F","#D9C79E",3,3,1.07),
            ("jiangwei","#557C76","#D7D2B0",3,0,1.08),
            ("dengai","#718B80","#D7B98A",3,1,1.05),
            ("zhonghui","#745F89","#D6C2A2",0,0,0.98),
            ("liaohua","#7B8A64","#D4BD83",2,2,1.07),
            ("masu","#A38769","#CFCCAD",5,1,0.97),
            ("caopi","#5B687D","#DAB882",0,1,1.04),
            ("caoren","#596F71","#CBB991",3,2,1.17),
            ("caohong","#9A7055","#D2C09B",2,1,1.12),
            ("yujin","#6B7579","#C8C2A7",3,1,1.1),
            ("lejin","#A16953","#DFC083",3,0,1.05),
            ("lidian","#748463","#E2CE9D",1,2,1.01),
            ("zhanghe","#547A83","#D4B9A0",3,1,1.09),
            ("xiahouyuan","#74715E","#D6B482",3,2,1.13),
            ("xusheng","#628C80","#E0CAA0",2,1,1.08),
            ("zhuhuan","#955F59","#D3BB96",3,1,1.07),
            ("zhugejin","#718E88","#DECDA8",0,2,1.03),
            ("buzhi","#8B8D72","#D2C2A0",5,1,0.98),
            ("yangxiu","#947580","#E5CBA0",0,0,0.95)]
